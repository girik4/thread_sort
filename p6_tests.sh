...
# make test files
dd if=/dev/urandom iflag=fullblock of=test1.img bs=1000000 count=10 &>> $LOG &
spinner $! generating test 1

dd if=/dev/urandom iflag=fullblock of=test2.img bs=1000000 count=100 &>> $LOG &
spinner $! generating test 2

dd if=/dev/urandom iflag=fullblock of=test3.img bs=1000000 count=1000 &>> $LOG &
spinner $! generating test 3

dd if=/dev/urandom iflag=fullblock of=test4.img bs=1000000 count=4000 &>> $LOG &
spinner $! generating test 4
